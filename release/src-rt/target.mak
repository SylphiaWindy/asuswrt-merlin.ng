...
export RT-AC86U += BUILD_NAME="RT-AC86U" NVSIZE="128" DHDAP=y DPSTA=y LACP=n WTFAST=y REPEATER=y \
				...
				HD_SPINDOWN=y NATNL_AIHOME=y ASPMD=n BCM_MEVENT=y BTM_11V=y BCN_RPT=y INFO_EXAP=y IPERF3=y \
				IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV DFS_US=y ALEXA=n IFTTT=n DWB=y \
				CFGSYNC_LOCSYNC=y OPEN_NAT=y CAPTCHA=y UUPLUGIN=y AHS=n ASD=n FRS_LIVE_UPDATE=n \
