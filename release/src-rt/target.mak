...
export RT-AC68U_BASE := IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
			...
			CONNDIAG=y NFCM=n FORCE_AUTO_UPGRADE=n FORCE_ROAMING=y BCN_RPT=y BTM_11V=y OOKLA=y \
...
export RT-AC86U += BUILD_NAME="RT-AC86U" NVSIZE="128" DHDAP=y DPSTA=y LACP=n WTFAST=y REPEATER=y \
				...
				NTPD=y DNSPRIVACY=y WIREGUARD=y
...
export RT-AX88U += BUILD_NAME="RT-AX88U" SWITCH2="BCM53134" NVSIZE="128" DHDAP=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
		IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y FRS_FEEDBACK=n NFCM=n \
...
export RT-AX56U += BUILD_NAME="RT-AX56U" SWITCH2="BCM53134" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y SW_CTRL_ALLLED=y \
		IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y BCN_RPT=y BTM_11V=y NFCM=n \
...
export RT-AX86U += BUILD_NAME="RT-AX86U" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y HND_WL=y \
		...
		DBLOG=y ETHOBD=y CFGSYNC_LOCSYNC=y CONNDIAG=y NFCM=n CRASHLOG=y BW160M=y \
...
export RT-AC88U_BASE := IPV6SUPP=y HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=3.6.x \
		...
		CONNTRACK=n AMASDB=y WATCH_REINIT=n MFGFW=n CTFNAT=y CONNDIAG=y NFCM=n UTF8_SSID=y \
